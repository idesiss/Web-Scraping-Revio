...
#Aqui as manipulações na página web acontecem mais rapido em comparação com o outro código (dependendo da sobrecarga computacional no momento, pode ser que trave)
